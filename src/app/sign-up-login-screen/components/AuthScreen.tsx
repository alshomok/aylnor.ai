  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(160deg, #0D3BAA 0%, #1B4FD8 45%, #0A0F1E 100%)',
        }}
      >
        {/* Decorative orbs */}
        <div
          className="absolute top-0 right-0 w-96 h-96 rounded-full pointer-events-none"
          style={{ background: 'radial-gradient(circle, rgba(212,160,23,0.18), transparent 70%)', filter: 'blur(60px)' }}
        />
        <div
          className="absolute bottom-0 left-0 w-72 h-72 rounded-full pointer-events-none"
          style={{ background: 'radial-gradient(circle, rgba(27,79,216,0.3), transparent 70%)', filter: 'blur(50px)' }}
        />
        ...
        <div className="relative z-10 text-right">
          ...
          <div className="space-y-4">
            {[
              ...
              return (
                <div key={`brand-feat-${item.label}`} className="flex items-center gap-4 flex-row-reverse">
