    ...
    <section className="relative pt-28 sm:pt-32 pb-20 sm:pb-24 px-4 sm:px-6 lg:px-10 overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto text-center">
        ...
        <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          aylnor.ai هو رفيقك الأكاديمي الذكي — مصمم للطلاب والمطورين الذين يحتاجون إجابات سريعة
          ودقيقة وواعية بالسياق. بدّل بين أوضاع السريع والمتأمل والبرمجة لتناسب سير عملك.
        </p>
        ...
        <div className="max-w-2xl mx-auto glass-card rounded-2xl overflow-hidden glow-blue">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-border flex-row-reverse">
            ...
            <span className="mr-3 text-xs text-muted-foreground font-medium">
              aylnor.ai — محادثة
            </span>
              ...
              {[
                ...
                <span
                  ...
                  className={`text-2xs px-2 py-0.5 rounded-full font-semibold border ${
                    mode.active ? 'badge-blue' : 'text-muted-foreground border-border'
                  }`}
                >
                  {mode.label}
                </span>
            ...
            <div className="flex items-start gap-3 flex-row-reverse">
              ...
              <div className="chat-bubble-bot text-sm px-4 py-3 max-w-sm text-right">
                <p className="leading-relaxed">
                  فكر في الانحدار التدريجي كقطعة تتدحرج أسفل تل — القطعة تتحرك دائماً نحو أدنى نقطة.
                  في التعلم الآلي، نحاول تقليل دالة الخسارة بضبط الأوزان في اتجاه أكبر انخفاض.
                </p>
