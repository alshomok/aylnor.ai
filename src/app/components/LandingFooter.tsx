      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 sm:gap-6 text-sm text-muted-foreground flex-wrap justify-center">
            <Link href="#" className="nav-link-hover">الخصوصية</Link>
            <Link href="#" className="nav-link-hover">الشروط</Link>
            <Link href="#" className="nav-link-hover">التواصل</Link>
            <Link href="/sign-up-login-screen" className="nav-link-hover">تسجيل الدخول</Link>
          </div>
