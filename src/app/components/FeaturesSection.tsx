...
const features = [
  ...
  },
  {
    ...
    title: 'مساعد البرمجة',
    description:
      'توليد وتصحيح وشرح الكود في أكثر من 20 لغة برمجة. احصل على تعليقات مضمنة وتحليل التعقيد واقتراحات أفضل الممارسات.',
    tags: ['Python', 'JavaScript', 'SQL', '+17 أخرى'],
  ...
  },
  {
    ...
    description:
      'بدّل بين السريع (إجابات فورية) والمفكر (شروحات عميقة) والمبرمج (أولوية الكود) لتناسب ما تحتاجه بالضبط.',
    tags: ['الوضع السريع', 'الوضع المفكر', 'وضع المبرمج'],
