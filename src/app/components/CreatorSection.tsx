          ...
          <div className="glass-card rounded-2xl p-6 sm:p-8 border border-gold/15">
            ...
            <div className="mt-6 pt-6 border-t border-border">
              <p className="text-xs text-muted-foreground leading-relaxed text-right">
                aylnor.ai مبني بهندسة full-stack حديثة — ردود مبثوثة عبر Server-Sent Events، وحفظ
                المحادثات في PostgreSQL، وذاكرة تخزين مؤقت مدعومة بـ Redis لتوجيه الاستجابات في أقل
                من 100ms.
              </p>
            </div>
          </div>
